                            ...
                            <%for(int i =0;i<list.size();i++){ %>
								<tr class="checkPoint<%=i%>">
								    ...
								    <td class="shoping__cart__price(<%=i%>)" id = "p_price<%=i%>" name="p_price<%=i%>">
								        <fmt:formatNumber value='<%=list.get(i).getItemPrice()%>' pattern='####' />
								    </td>
								    ...
								    <td class="shoping__cart__total<%=i%> total"><%=list.get(i).getItemPrice()%>원</td>
								    <td>
								    	<%
								    		if("X".equals(list.get(i).getAuthyn())){
								    			out.println("<B>미 결재</b>");
								    		}else if(!"X".equals(list.get(i).getAuthyn())){
								    			out.println("<B style='color:red;';>결재 완료</b>");
								    		} else{
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            ...
                            <li>할인 금액 <span><span id="checkoutTotalPrice_T">0원</span></li>
	            ...
	            success : function(res) {
	               ...
	               if(res == 1){
	            	   ...
	            	   var item_total = document.querySelectorAll('.total');
		               	...
		               	document.querySelector('#checkoutTotalPrice_T').innerHTML = resultMoney;
		           	    document.querySelector('#checkoutTotalPrice').innerHTML = resultMoney;
	               }else {
	            	   alert('수정실패');
	               }
	            },
