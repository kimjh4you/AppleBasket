            ...
            <!-- 왼쪽자리  -->
             ...
             <!--left자리 -->
                ...
                <div class="col-lg-9 col-md-7">
	                    ...
	                    <div class="row">
	                   		<form name="purchase" method="post" action="./purchaseWrite.do" enctype="multipart/form-data">
	                    	<table class="table">
							   <thead>
							    <tr></tr>
							  </thead>
							  <tbody>
							    <tr>
							      ...
							      <td>
							      	<input type="hidden" name="mbId" value="<c:out value="${sessionScope.vo.mbId}"/>">
							      	${sessionScope.vo.mbName}&nbsp;&nbsp;( <c:out value="${sessionScope.vo.mbId}"/> )
							      </td>
							    </tr>
							    <tr>
							      <th scope="row" class="text-right">아이템이름</th>
							      <td><input type="text" name="itemName" id="itemName" class="itemName"></td>
							    </tr>
							   	<tr>
							      <th scope="row" class="text-right">아이템 가격</th>
							      <td><input type="text" name="itemPrice" id="itemPrice" class="itemPrice"></td>
							    </tr> 
							   	<tr>
							    ...
							    <tr>
							      ...
							      <td>
							      <input type="hidden" name="safeSeq" value="86" id="safeSeq" class="safeSeq">
							     ...
							     <tr>
							      ...
							      <td><input type="file" name="itemImg1" id="itemImg1" class="itemImg1"/></td>
							    </tr>
							    <tr>
							      <th scope="row" class="text-right">상품사진 2</th>
							      <td><input type="file" name="itemImg2" id="itemImg2" class="itemImg2"/></td>
							    </tr>
							    <tr>
							      <th scope="row" class="text-right">상품사진 3</th>
							      <td><input type="file" name="itemImg3" id="itemImg3" class="itemImg3"/></td>
							    </tr>
							     <tr>
							      <th scope="row" class="text-right">신청자 수</th>
							      <td><input type="text" name="curQuant" id="curQuant" class="curQuant"></td>
							    </tr>
							    <tr>
							      <th scope="row" class="text-right">아이템 수량</th>
							      <td><input type="text" name="itemQuant" id="itemQuant" class="itemQuant"></td>
							    </tr>
							    <tr>
							      <th scope="row" class="text-right">상품 설명</th>
							      <td><textarea rows="4" cols="40" name="itemDesc"  id="itemDesc" class="itemDesc"></textarea></td>
							    </tr>
							  </tbody>
							</table>
	                    ...
	                    <div class="text-right">
	                       	<!-- 버튼을 둘자리 -->
	                       	 ...
	                       	 <!-- 등록할때 -->
	                    		<button type="button" class="btn btn-secondary" onclick="javascript:history.go(-1);">목록 </button> | <button type="submit" class="btn btn-success"> 등록 </button> 
